...
const Footer = () => {
  return (
    <footer className="mx-4 border-t-[1px] py-16 px-6 md:px-[200px]">
        ...
        <div className="flex-1 flex flex-col gap-4 mt-6 md:mt-0">
          <div className="columns-2 lg:columns-3">
            {FooterLinks?.map((item, i) => {
              return (
                <div key={i} className="">
                  <span className="text-md font-semibold">{item.tag}</span>
                  <ul className="pl-[2px] flex flex-col gap-1 mt-2 mb-8">
                    {item?.Links.map((it, i) => {
                      return (
                        <li key={i} className="text-gray-400 font-[500] ">
                          <a
                            href={it.link}
          ...
          <div className="">
            <p className="text-sm hover:cursor-pointer">Do Not Sell or Share My Info</p>
